...
import { Text, View, ScrollView, Pressable, Animated, ActivityIndicator } from 'react-native';
    ...
    <View className="flex-1" style={{ backgroundColor: '#f9fafb' }}>
      ...
      {showBanner && (
        <Animated.View style={{ transform: [{ translateY: bannerAnim }] }}>
          <View style={{ backgroundColor: '#012d1d', paddingHorizontal: 16, paddingVertical: 12 }}>
      ...
      >
        ...
        <View className="mt-2 px-4">
          <Card style={{ marginBottom: 12, padding: 12 }}>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
              <Text style={{ fontSize: 20, fontWeight: '700', color: '#012d1d' }}>Cereal Sales</Text>
              <View style={{ backgroundColor: '#e0e7ff', borderRadius: 20, paddingHorizontal: 12, paddingVertical: 4 }}>
                <Text style={{ color: '#012d1d', fontSize: 12, fontWeight: '700' }}>Unit: Korokoro</Text>
              </Vella>
            </View>
        ...
        >
          <Text className="text-base font-semibold" style={{ color: '#6b7280' }}>+ Add Custom Item</Text>
        </Pressable>

        {/* Poshomill Services Section */}
        <View className="px-4 mt-4">
          <Card style={{ marginBottom: 12, padding: 12 }}>
            <Text style={{ fontSize: 20, fontWeight: '700', marginBottom: 12, color: '#012d1d' }}>Poshomill Services</Text>
            <View>
        ...
        <View className="px-4 mt-4">
          <Card style={{ marginBottom: 12, padding: 12 }}>
            <Text style={{ fontSize: 20, fontWeight: '700', marginBottom: 12, color: '#012d1d' }}>Packaging</Text>
            <View>
      ...
      {items.length > 0 && (
        ...
        >
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
            ...
            <Text style={{ fontSize: 14, fontWeight: '500', color: 'white', opacity: 0.9 }}>
          ...
          >
            <Text style={{ fontSize: 16, fontWeight: '600', color: '#012d1d', textAlign: 'center' }}>
              Confirm Sale
            </Text>
          </Pressable>
        </View>
