...
import { Text, View, ScrollView, Pressable, TouchableOpacity, Alert, ActivityIndicator } from 'react-native';
...
export default function InventoryScreen() {
  ...
  const lowStockItems = allItems.filter(item => item.currentStock < 10);
